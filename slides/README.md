...
2.  [Simple Interpreter](Fall/02_Interpreters.pdf)
...
3.  [Decoder](Fall/03_Ruby_Intro.pdf)
    - Introduction into Ruby Language
    - Metaprogramming and DSL Intro

4.  [ELF](Fall/04_ELF.pdf)
    - Virtual Memory
    - Executable and Linkable Format
    - Review Linux address space
    - elfio usage example

5.  [Advanced Simulation Techniques](Fall/05_DBT.pdf)
...
6.  [Architecture Description Language](Fall/06_ADL.pdf)
...
7.  [Memory Management Unit](Fall/07_MMU.pdf)
    - Motivation
    - RISC-V example (Sv32)
    - TLB
    - Exception Levels
...
8.  [Trace Driven Simulation](Fall/08_TDS.pdf)
...
11. [Classification](Spring/11_Classification_n_Protea_Intro.pdf)
    - Simulation Classification Survey
    - Introduction into Protea Framework
    - Cooperation Project Rules

12. [Testing](Spring/12_13_Testing.pdf)
    - Unit Testing
    - Automated Testing and its application
    - Fuzzing
    - Co-simulation

13. [Caches](Spring/14_Caches.pdf)
    - CPU Test Generation
    - Static Symbolic Execution
    - Coverage

14. [Caches](Spring/14_Caches.pdf)
    - Introduction into the concept and structure of caches
    - Cache memory modeling and its corner cases
    - Cache Coherence Protocols
    - Prefetching (HW/SW)

15. [Digital Logic](Spring/15_Digital_Logic.pdf) (based Digital Design and Computer Architecture)
    - Digital Logic Level
...
16. [Pipeline](Spring/16_Pipeline.pdf) (based Digital Design and Computer Architecture)
    - uArch Level
...
17. [Cycle-Accurate Models](Spring/17_Device_Descritption.pdf)
    - Introduction into Cycle-Accurate models
    - CA models software implementation details
    - gem5 Introduction & Overview

18. [System Description Overview](Spring/17_System_Descritption.pdf)
...
19. [FP & SIMD Introduction](Spring/19_FP_n_SIMD.pdf)
    - History
    - AArch64 FP & SIMD
    - RVV
